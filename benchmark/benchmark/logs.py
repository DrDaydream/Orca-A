...
class LogParser:
    def __init__(self, clients, primaries, workers, faults=0):
        ...
        proposals, commits, header_proposals, header_commits, rule_orders, commit_rules, self.configs, primary_ips = zip(*results)
    ...
    def _parse_primaries(self, log):
        ...
        return proposals, commits, header_proposals, header_commits, rule_orders, commit_rules, configs, ip
